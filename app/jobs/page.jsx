                            ...
                            <>
                                <div className="bg-white rounded-xl p-4 px-6 shadow-sm">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-medium">Save this search as alert</span>
                                    </div>
                                </div>
                                <div className="bg-white rounded-xl p-6 shadow-sm sticky top-24 mt-4">
                                    ...
                                    <div className="flex items-center justify-between mb-6">
                                        ...
                                        <button className="text-prime text-sm underline">Clear</button>
                                    </div>
                                    ...
                                    {/* Salary Range */}
                                    <div className="mb-6">
                                        <label className="block text-base font-medium mb-4 text-gray-800">Annual Salary (In Lakhs)</label>
                                        <div className="relative px-2">
                                            {/* Labels */}
                                            <div className="flex justify-between mb-3">
                                                <span className="text-sm font-medium text-gray-700">{salaryRange.min}L</span>
                                                <span className="text-sm font-medium text-gray-400">50L+</span>
                                            </div>
                                            ...
                                            <div className="relative h-1 bg-gray-200 rounded-full">
                                                <div
                                                    ...
                                                    style={{
                                                        ...
                                                        right: `${100 - ((salaryRange.max - 1) / 49) * 100}%`
                                                    }}
                                                />
                                            </div>
                                ...
                                <div className=" ">
                                    <div className="relative w-full h-[500px] bg-white rounded-xl shadow-sm overflow-hidden border-white border-4">
                                        <iframe
                                            ...
                                            src={`https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=${encodeURIComponent(searchLocation || 'India')}&zoom=12`}
                                        />
                                    </div>
